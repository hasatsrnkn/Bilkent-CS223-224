...
REM
REM Generated by Vivado on Fri Nov 18 13:23:22 +0300 2022
...
echo "xvlog --incr --relax -L uvm -prj testbench1_vlog.prj"
call xvlog  --incr --relax -L uvm -prj testbench1_vlog.prj -log xvlog.log
