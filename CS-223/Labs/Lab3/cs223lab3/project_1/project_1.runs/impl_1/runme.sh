...
HD_PWD='C:/Users/MONSTER/Desktop/cs223lab3/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder2_to_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder2_to_4.tcl -notrace
