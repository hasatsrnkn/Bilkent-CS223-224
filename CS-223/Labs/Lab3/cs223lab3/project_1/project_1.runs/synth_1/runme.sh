...
HD_PWD='C:/Users/MONSTER/Desktop/cs223lab3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder2_to_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder2_to_4.tcl
