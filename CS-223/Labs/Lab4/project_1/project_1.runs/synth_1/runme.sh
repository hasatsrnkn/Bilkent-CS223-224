...
HD_PWD='C:/Users/MONSTER/Desktop/lab4_21901649/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trafficSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trafficSystem.tcl
