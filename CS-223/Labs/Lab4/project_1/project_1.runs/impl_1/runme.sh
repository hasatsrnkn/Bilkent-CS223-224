...
HD_PWD='C:/Users/MONSTER/Desktop/lab4_21901649/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trafficSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trafficSystem.tcl -notrace
