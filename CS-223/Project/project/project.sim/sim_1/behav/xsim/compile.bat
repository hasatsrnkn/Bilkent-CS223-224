...
REM
REM Generated by Vivado on Mon May 09 21:29:26 +0300 2022
...
echo "xvlog --incr --relax -L uvm -prj testbench4_vlog.prj"
call xvlog  --incr --relax -L uvm -prj testbench4_vlog.prj -log xvlog.log
